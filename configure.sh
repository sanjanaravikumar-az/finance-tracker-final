...
# Copy GraphQL schema
cp -f schema.graphql ./amplify/backend/api/financetrackerfinal/schema.graphql
...
cp -f customfinance.ts ./amplify/backend/custom/financereport/cdk-stack.ts

# Copy CDK stack for customresolver
cp -f customresolver.ts ./amplify/backend/custom/filterresolver/cdk-stack.ts